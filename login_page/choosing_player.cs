...
{
    public partial class choosing_player : Form
    {
        public choosing_player()
        {
        ...
        private void choosing_player_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                viewer d = new viewer(player_name, jersey_no);
                d.Show();
